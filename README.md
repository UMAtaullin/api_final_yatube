# REST API социальной сети Yatube (Проект создан в рамках учебного курса Яндекс.Практикум)

## Описание

Проект api_final_yatube - это [API социальной сети Yatube](git@github.com:UMAtaullin/Yatube.git).
Yatube - это социальная сеть с авторизацией, персональными лентами, комментариями и подписками на авторов статей.
Реализован CRUD REST API для основных моделей проекта. Для аутентификации используются JWT-токены. В проекте реализованы пермишены, фильтрации, сортировки и поиск по запросам клиентов. Также реализована пагинация ответов от API и установлено ограничение количества запросов к API.
...
1. Клонировать репозиторий:
   ...
   ```python
   git clone git@github.com:UMAtaullin/api_final_yatube.git
   ```
